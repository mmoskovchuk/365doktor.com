    ...
    <div class="container cta__back">
        <div class="cta">
            <div class="cta__text">
                ...
                <p>Is there a medical condition you like to seek treatment for? Don’t have time to visit your doctor? We are here to help.</p>
                <p>Click the button below to choose your treatment and get online doctor assessment followed by electronic prescription.</p>
        ...
        <div class="container-section">
            <div class="flex-block">
                <div class="flex-block__text">
                    ...
                    <p>Now you no longer need to leave your home to get a medical consultation. Our online doctor clinic offers men and women a faster and easier way to get treatment for common conditions. Simply answer a short questionnaire to get an online prescription from a licensed doctor, 24/7. No more wasting time commuting. No more uncomfortable doctor visits. No more hassle at your local pharmacy (if) you choose to redeem your e-prescription and get your medication delivered to your doorstep through our partner mail-order pharmacy.</p>
            ...
            <div class="safe">
                ...
                <div><img src="<?php bloginfo('template_url'); ?>/img/registered-pharmacy.png" alt="registered pharmacy"></div>
                <div><img src="<?php bloginfo('template_url'); ?>/img/verify.png" alt=""></div>
                <div><img src="<?php bloginfo('template_url'); ?>/img/cyber-essentials.png" alt="cyber essentials"></div>
    ...
    <section class="container-section">
        <div class="flex-block">
            <div class="flex-block__text">
                ...
                <p>Telemedicine in Europe has completely transformed the way people get medical consultations and prescriptions. The evolving climate of regulations in the EU has taken many patients out of doctor waiting rooms and into online health clinics, where they can get an online doctor consultation from the comfort of their home. 365Doktor is one of the first and leading telemedicine companies offering online doctor consultations for men and women seeking treatment for a wide variety of conditions.</p>
                <a href="javascript:void(0);" class="cta__btn btn">Start Online Doctor Consultation</a>
            </div>
